    ...
    return (
        <div
            ...
            <div className="flex flex-row-reverse md:ml-24 h-[344px] md:h-[500px]">
                <div className="md:mt-[170px] md:mr-[200px]">
                    <div className=" md:w-1/4">
                        <h3 className="text-[40px] font-bold text-white md:mt-[-10px]">{title}</h3>
                        <h4 className="text-[40px] font-extralight text-white mb-4">{subTitle}</h4>
